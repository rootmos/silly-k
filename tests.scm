...
(define test-cases
  (list
    ...
    (make-test-case "addition07" "]1+2=1 2 3"                         #f                 "1 2 1")
    (make-test-case "addition08" "](2=1 2 3)+1"                       #f                 "1 2 1")
    ...
    (make-test-case "head01"     "]*1 2 3"                            #f                 "1")
    (make-test-case "head02"     "]*0=0 1"                            #f                 "1")
    (make-test-case "head03"     "]*0=1 0"                            #f                 "0")
    (make-test-case "head04"     "](*0=0 1;7;8)"                      #f                 "7")
    (make-test-case "head05"     "](*0=1 0;7;8)"                      #f                 "8")
    (make-test-case "shape01"    "]#1 2 3"                            #f                 "3")
    ...
    (make-test-case "over07"     "]{w@1}'{+w}'1 2 3"                  #f                 "2 3 4")
    (make-test-case "over08"     "]{w@1}'{-w}'1 2 3"                  #f                 "0 -1 -2")
